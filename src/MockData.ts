...
export const MOCK_PROJECTS: Project[] = [
  {
    ...
    thumbnail: 'src/assets/peek_a_boo.png',
    videoUrl: 'src/assets/videos/peek-a-boo recording (compressed).mp4',
  ...
  },
  {
    ...
    thumbnail: 'src/assets/pbb screenshot.png',
    videoUrl: 'src/assets/videos/Proud Bisaya Bai  (compressed).mp4',
  ...
  },
  {
    ...
    thumbnail: 'src/assets/lucky defense bot screenshot.png',
    videoUrl: 'src/assets/videos/Lucky Defense Bot Demo .mp4',
  ...
  },
  {
    ...
    thumbnail: 'src/assets/linya landing page.jpeg',
    videoUrl: 'src/assets/videos/linya.mp4',
  ...
  },
  {
    ...
    thumbnail: 'src/assets/project_gaia_home_page.png',
    videoUrl: 'src/assets/videos/project_gaia no audio.mp4',
  ...
  },
  {
    ...
    thumbnail: 'src/assets/sugbo intern login page.png',
    videoUrl: 'src/assets/videos/sugbo intern.mp4',
