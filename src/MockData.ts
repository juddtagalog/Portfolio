...
export const MOCK_PROJECTS: Project[] = [
  {
    ...
    thumbnail: import.meta.env.BASE_URL + 'peek_a_boo.png',
    videoUrl: import.meta.env.BASE_URL + 'videos/peek-a-boo recording (compressed).mp4',
  ...
  },
  {
    ...
    thumbnail: import.meta.env.BASE_URL + 'pbb screenshot.png',
    videoUrl: import.meta.env.BASE_URL + 'videos/Proud Bisaya Bai  (compressed).mp4',
  ...
  },
  {
    ...
    thumbnail: import.meta.env.BASE_URL + 'lucky defense bot screenshot.png',
    videoUrl: import.meta.env.BASE_URL + 'videos/Lucky Defense Bot Demo .mp4',
  ...
  },
  {
    ...
    thumbnail: import.meta.env.BASE_URL + 'linya landing page.jpeg',
    videoUrl: import.meta.env.BASE_URL + 'videos/linya.mp4',
  ...
  },
  {
    ...
    thumbnail: import.meta.env.BASE_URL + 'project_gaia_home_page.png',
    videoUrl: import.meta.env.BASE_URL + 'videos/project_gaia no audio.mp4',
  ...
  },
  {
    ...
    thumbnail: import.meta.env.BASE_URL + 'sugbo intern login page.png',
    videoUrl: import.meta.env.BASE_URL + 'videos/sugbo intern.mp4',
