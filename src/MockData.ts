...
export const MOCK_PROJECTS: Project[] = [
  {
    ...
    videoUrl: import.meta.env.BASE_URL + 'assets/videos/peek-a-boo-recording(compressed).mp4',
  ...
  },
  {
    ...
    videoUrl: import.meta.env.BASE_URL + 'assets/videos/proud-bisaya-bai(compressed).mp4',
